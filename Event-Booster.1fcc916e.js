...
},{"./js/events":"aKbDR"}],"aKbDR":[function(require,module,exports,__globalThis) {
...
function inputSearching() {
    ...
    fetch(API_KEY).then((response)=>response.json()).then((data)=>{
        ...
        array.forEach((element)=>{
            ...
            if (name.toLowerCase().includes(inputValue.toLowerCase())) console.log(name);
            else return false;
